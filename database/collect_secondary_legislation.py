...
# List of all UK secondary legislation types
legislation_types = [
    "uksi", "wsi", "ssi", "nisa", "ukci", "ukmd", "ukmo", "uksro", "nisro"
]
...
output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "uk_secondary_legislation.json")
