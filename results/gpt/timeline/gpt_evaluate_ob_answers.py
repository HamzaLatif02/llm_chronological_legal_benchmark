...
gpt_answers = [ans for ans in gpt_answers if ans.get("task_id", "").startswith("OB")]
...
for ans in gpt_answers:
    ...
    result = {
        ...
        "gpt_main_snippet": gpt_main_raw[:300],
        "gpt_with_dates_snippet": gpt_dates_raw[:300]
    }
...
print("Results saved to 'gpt_ob_responses.json'")

# Save results in JSON format
with open("gpt_ob_responses.json", "w", encoding="utf-8") as f:
