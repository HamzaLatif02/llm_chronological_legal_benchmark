...
claude_data = [x for x in claude_data if x.get("task_id", "").startswith("SE")]
...
print("Results saved to 'claude_se_responses.json'")

# Save results in JSON format
with open("claude_se_responses.json", "w", encoding="utf-8") as f:
